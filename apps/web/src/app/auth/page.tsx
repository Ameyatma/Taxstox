...
function AuthContent() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // In production, replace with actual Google Client ID from console.cloud.google.com
      ...
      if (!client) {
        ...
        script.async = true;
        script.onload = () => initiateGoogleSignIn();
        document.head.appendChild(script);
        return;
      }
      initiateGoogleSignIn();
    } catch (err) {
      setError("Google sign-in failed. Please use email sign-up.");
